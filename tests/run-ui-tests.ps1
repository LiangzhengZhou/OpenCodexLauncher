...
& $compiler /nologo /target:exe /platform:x64 "/out:$test" "/reference:$reference" @refs (Join-Path $PSScriptRoot 'UiChecks.cs') (Join-Path $PSScriptRoot 'WorkspaceUiChecks.cs') (Join-Path $PSScriptRoot 'InstallerChecks.cs')
