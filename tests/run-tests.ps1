...
& $compiler /nologo /target:exe /platform:x64 "/out:$test" "/reference:$reference" /reference:System.Web.Extensions.dll /reference:System.IO.Compression.dll /reference:System.IO.Compression.FileSystem.dll (Join-Path $PSScriptRoot 'RegressionChecks.cs') (Join-Path $PSScriptRoot 'ReleaseChecks.cs') (Join-Path $PSScriptRoot 'InstallerChecks.cs')
